...
describe PassaporteWeb::Client::ExceptionWrapper do
  ...
  describe '#request' do
    ...
    it 'should raise an exception for Faraday::ClientError' do
      ...
      expect { subject.request(:get, '/api/v1/profile') }.to raise_error(PassaporteWeb::Client::Exception)
    end
  ...
  describe '#refresh' do
    ...
    it 'should raise an exception for Faraday::ClientError' do
      ...
      expect { subject.refresh(a: :b) }.to raise_error(PassaporteWeb::Client::Exception)
    end
